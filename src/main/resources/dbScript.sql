...
insert into appuser(id,email,firstname,lastname,password,username,createdBy,lastModifiedBy,createdDate,lastModifiedDate) values(1,'abc@gmail.com','John','Doe','password','user','kbowersox',null,CURRENT_TIMESTAMP(),null);
